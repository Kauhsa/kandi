...
Useaa tietokonetta hyödyntäen voidaan suorittaa vaativampia laskentatehtäviä nopeammin kuin vain yhtä tietokonetta käyttämällä olisi mahdollista. *Klusteri* viittaa joukkoon tietoliikenneyhteyksillä toisiinsa yhdistettyjä itsenäisiä tietokoneita, joissa ei yleensä hyödynnetä erikoisvalmisteisia komponentteja [@cluster-white-paper]. Suurten, datan käsittelyyn erikoistuneiden yritysten, kuten Googlen [@mapreduce] klustereihin voi kuulua satoja tai tuhansia tietokoneita. Hyödyntääkseen laskennassa useita tietokoneita ei kuitenkaan tarvitse tehdä suuria invesointeja omaan infrastruktuurin – yritykset voivat käyttää hyväkseen infrastruktuuria tai laskentaa palveluna tarjoavia yrityksiä, joista kustannuksia syntyy vain palvelun käytön mukaan [@cloudcomputing s. 50].
