...
\abstract{Suurten tietomäärien analysointi ei ole mahdollista käyttämällä vain yhtä tietokonetta. MapReduce on Googlen vuonna 2003 esittelemä ohjelmointimalli, jota voi käyttää suurten tietomäärien käsittelyyn hajauttamalla laskentatyö usean tietokoneen kesken. Ohjelmointimalli käyttää abstraktionaan map- ja reduce-nimisiä funktioita, jotka ohjelmointimallin käyttäjä toteuttaa ohjelmassaan. Ohjelmointimallin toteuttavan kirjaston käyttäjän ei tarvitse kiinnittää huomiota moniin hajautetun laskennan yksityiskohtiin, kuten tietokoneiden väliseen kommunikointiin.

Tutkielmassa tutustutaan MapReduce-ohjelmointimallin käyttöön ja toimintaan, tarkastellaan ohjelmointimallin optimointeja sekä verrataan MapReduce-ohjelmointimallia muihin hajautetun laskennan ratkaisuihin.}
